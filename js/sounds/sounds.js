...
KiddoPaint.Sounds.explosion = function() {
    KiddoPaint.Sounds.Library.play('explosion');
}
KiddoPaint.Sounds.oops = function() {
    KiddoPaint.Sounds.Library.play('oops');
}
KiddoPaint.Sounds.pencil = function() {
    KiddoPaint.Sounds.Library.play('pencil');
}
KiddoPaint.Sounds.stamp = function() {
    KiddoPaint.Sounds.Library.play('stamp');
}
KiddoPaint.Sounds.flood = function() {
    KiddoPaint.Sounds.Library.play('flood');
}